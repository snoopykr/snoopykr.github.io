...
Local에서 Llama3와 LangGraph을 구현해 보자.

### Python

주피터에서 돌아가는 학예회 프로그램이 아닌 실무에서 사용할수 있는 수준의 개발 필요

메인 소스는 retrieval, websearch 두 파트로 되어 있다.
...
def main():
    ...
    try:
        ...
        open('IntroOut1.jpg', 'wb').write(graph_image.data)
    except:
        pass
    ...
    # try:
    #     graph_image = Image(app.get_graph(xray=True).draw_mermaid_png())
    #     open('IntroOut2.jpg', 'wb').write(graph_image.data)
    # except:
    #     pass
    #
